...
void loop() {
    ...
    // otherwise, check for DMP data ready interrupt (this should happen frequently)
        ...
        fifoCount -= packetSize;
            ...
            JsonArray& w = JSONencoder.createNestedArray("w");
            JsonArray& x = JSONencoder.createNestedArray("x");
            JsonArray& y = JSONencoder.createNestedArray("y");
            JsonArray& z = JSONencoder.createNestedArray("z");
...
void makePOST()
{
  if(!client.connect(rpiHost,80))     //Here connect to the server
  {
  ...
  {    
    ...
    client.println(JSONencoder.length());
    client.println();
    client.println(JSONencoder);
  }
  if(client.connected()){
    client.stop();
  }  
